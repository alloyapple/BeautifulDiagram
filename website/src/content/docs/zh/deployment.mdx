...
BeautifulDiagram 生产环境由以下服务组成：

| 服务 | 技术栈 | 镜像 |
|------|--------|------|
| **前端** | React 19 + Nginx | `alloyapple/beautifuldiagram-frontend:latest` |
| **后端** | FastAPI + LangGraph | `alloyapple/beautifuldiagram-backend:latest` |
