...
|---------|-----------|-------|
| **Frontend** | React 19 + Nginx | `twwch/beautifuldiagram-frontend:latest` |
| **Backend** | FastAPI + LangGraph | `twwch/beautifuldiagram-backend:latest` |
...
services:
  ...
  backend:
    image: twwch/beautifuldiagram-backend:latest
  ...
  frontend:
    image: twwch/beautifuldiagram-frontend:latest
